...
INTRO_FIELDS = [
    ("goal", "Для какой цели ты учишь английский?"),
    ("desired_result", "Какой результат ты хочешь получить в идеале?"),
    ("name", "Как тебя зовут?"),
    ("age", "Сколько тебе лет?"),
    ("city", "Из какого ты города?"),
]

# Подписи для вывода в результатах
INTRO_LABELS_RU = {
    "goal": "Цель обучения",
...
QUESTIONS = [
    {
        "id": 1,
        "part": "Часть 1. Основная грамматика",
    ...
    {
        "id": 11,
        "part": "Часть 3. Modal verbs & Reported speech",
    ...
    {
        "id": 21,
        "part": "Часть 7. Prepositions & patterns",
...
CTA_TEXT = (
    "Если хочешь повысить уровень – мы поможем, оставь свой телеграм и менеджеры свяжутся."
)
